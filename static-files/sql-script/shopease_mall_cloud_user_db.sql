# 创建用户服务所需数据
CREATE DATABASE /*!32312 IF NOT EXISTS*/`shopease_mall_cloud_user_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `shopease_mall_cloud_user_db`;

DROP TABLE IF EXISTS `tb_shopease_mall_admin_user`;

# 创建管理员用户表

CREATE TABLE `tb_shopease_mall_admin_user` (
...
INSERT INTO `tb_shopease_mall_admin_user` (`admin_user_id`, `login_user_name`, `login_password`, `nick_name`, `locked`)
VALUES
(1,'admin','e10adc3949ba59abbe56e057f20f883e','十三',0),
(2,'shopease-admin1','e10adc3949ba59abbe56e057f20f883e','新蜂01',0),
(3,'shopease-admin2','e10adc3949ba59abbe56e057f20f883e','新蜂02',0);

DROP TABLE IF EXISTS `tb_shopease_mall_user`;

# 创建商城用户表

CREATE TABLE `tb_shopease_mall_user` (
...
INSERT INTO `tb_shopease_mall_user` (`user_id`, `nick_name`, `login_name`, `password_md5`, `introduce_sign`, `is_deleted`, `locked_flag`, `create_time`)
VALUES
