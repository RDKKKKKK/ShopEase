# 创建订单服务所需数据
CREATE DATABASE /*!32312 IF NOT EXISTS*/`shopease_mall_cloud_order_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `shopease_mall_cloud_order_db`;

DROP TABLE IF EXISTS `tb_shopease_mall_order`;

CREATE TABLE `tb_shopease_mall_order` (
                                        ...
                                        `pay_time` timestamp NULL DEFAULT NULL COMMENT '支付时间',  -- 修改了这里
...
# Dump of table tb_shopease_mall_order_address
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_shopease_mall_order_address`;

CREATE TABLE `tb_shopease_mall_order_address` (
...
# Dump of table tb_shopease_mall_order_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_shopease_mall_order_item`;

CREATE TABLE `tb_shopease_mall_order_item` (
...
DROP TABLE IF EXISTS `tb_shopease_mall_user_address`;

CREATE TABLE `tb_shopease_mall_user_address` (
