...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`shopease_mall_cloud_cart_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `shopease_mall_cloud_cart_db`;

DROP TABLE IF EXISTS `tb_shopease_mall_shopping_cart_item`;

CREATE TABLE `tb_shopease_mall_shopping_cart_item` (
