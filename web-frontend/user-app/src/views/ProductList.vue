...
<template>
  <div class="product-list-wrap">
    <div class="product-list-content">
      ...
      <van-tabs type="card" color="#f7c04a" @click-tab="changeTab" >
        <van-tab title="Recomended" name=""></van-tab>
        <van-tab title="New" name="new"></van-tab>
    ...
    <div class="content">
      <van-pull-refresh v-model="state.refreshing" @refresh="onRefresh" class="product-list-refresh">
        <van-list
          ...
          :finished-text="state.productList.length ? 'No More' : 'Search'"
          @load="onLoad"
          @offset="10"
        >
