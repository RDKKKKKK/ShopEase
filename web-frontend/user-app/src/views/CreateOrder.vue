<template>
  <div class="create-order">
    <s-header :name="'Generate orders'" @callback="deleteLocal"></s-header>
    ...
    <div class="pay-wrap">
      ...
      <van-button @click="handleCreateOrder" class="pay-btn" color="#FFA500" type="primary" block>Generate
        Order</van-button>
    </div>
    <van-popup closeable :close-on-click-overlay="false" v-model:show="state.showPay" position="bottom"
      ...
      <div :style="{ width: '90%', margin: '0 auto', padding: '50px 0' }">
        <van-button :style="{ marginBottom: '10px' }" color="#FFA500" block
          @click="handlePayOrder(1)">AliPay</van-button>
        <van-button color="#FFA500" block @click="handlePayOrder(2)">WechatPay</van-button>
      </div>
    </van-popup>
  </div>
</template>
