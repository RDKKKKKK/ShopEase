...
package ltd.shopcart.cloud.shopease.config;
...
public class ShopCartServiceSwagger3Config{
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("ltd.shopcart.cloud.shopease.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("shopease-mall-cloud-shop-cart-service接口文档")
