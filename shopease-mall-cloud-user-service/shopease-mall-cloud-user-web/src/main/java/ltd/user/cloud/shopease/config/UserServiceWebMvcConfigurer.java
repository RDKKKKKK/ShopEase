...
import ltd.user.cloud.shopease.config.handler.TokenToAdminUserMethodArgumentResolver;
import ltd.user.cloud.shopease.config.handler.TokenToMallUserMethodArgumentResolver;
